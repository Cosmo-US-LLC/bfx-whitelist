    ...
    <div className="pt-[24px] pb-[24px]">
      <div className="pt-[14px] pb-[31px] px-[15px] space-y-[20px]  w-[90%] mx-auto bg-[#fff]">
        <div className="w-[100%] max-w-[521px] space-y-[20px]">
          ...
          <p className="text-[15px] max-w-[330px] mx-auto text-[#181A20] font-[400] leading-[153.333%] tracking-[-0.32px] text-center">$BFX is the first cryptocurrency to offer daily USDT staking rewards from every trade made on an international multi-asset trading platform. $BFX holders earn returns based on their holdings. The more $BFX you hold, the more USDT you earn.
          </p>
        </div>
        <div className="w-[100%]  flex justify-center min-h-[333px] bg-[#EBEBEB] rounded-[8px]">
