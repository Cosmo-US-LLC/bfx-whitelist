        ...
        <div className=" space-y-[40px]">
         ...
         >
            <div className="space-y-[10px] max-w-[324.48px] h-[160px] flex items-center justify-center flex-col w-[100%] relative mx-auto pb-[2.4rem]">
                ...
                <img  loading="lazy" src={rwdimg1} className="max-w-[194px] w-[100%] absolute top-[-3%]"  alt="" />
            </div>
            <div className="flex justify-center ">
                <img  loading="lazy" src={rwdimg2} className="max-h-[240px] object-cover" alt="" />
            </div>
         </div>
         ...
         >
            ...
            <div className="">
                <img  loading="lazy" src={rwdimg3} className="w-[100%] object-cover"  alt="" />
            </div>
         </div>
